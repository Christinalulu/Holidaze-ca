						...
						<div>
							<div className='border-b border-gray-200'>
								<div
									...
									<button
										id='tab-reviews'
										className='border-transparent text-gray-700 hover:border-gray-300 hover:text-gray-800 whitespace-nowrap border-b-2 py-6 text-sm font-medium'
									...
									<div className='py-10'>
										...
										<div className='prose prose-sm mt-4 max-w-none text-gray-500'>
											<p>
												...
												icon for just about anything I could ever need. Love the playful
												look!
											</p>
										</div>
									</div>
							...
							<div
								...
								<dl>
									...
									<dd className='prose prose-sm mt-2 max-w-none text-gray-500'>
										<p>
											Yes. The icons are drawn on a 24 x 24 pixel grid, but the icons can
											be scaled to different sizes as needed. We don&#039;t recommend going
											smaller than 20 x 20 or larger than 64 x 64 to retain legibility and
											visual balance.
										</p>
									</dd>
							...
							<div
								...
								<div className='prose prose-sm max-w-none text-gray-500'>
									...
									<ul role='list'>
										...
										<li>
											Make them your own. Change the colors to suit your project or brand.
										</li>
									</ul>
									...
									<ul role='list'>
										<li>
											Don't be greedy. Selling or distributing these icons in their
											original or modified state is prohibited.
										</li>
										<li>
