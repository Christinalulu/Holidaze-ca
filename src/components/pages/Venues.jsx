...
const Venues = () => {
	...
	const { product } = useSelector((state) => state.venueSlice);
							...
							<div key={product.id}>
								<div className='group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white'>
									...
									<div className='flex flex-1 flex-col space-y-2 p-4'>
										...
										<p className='text-sm text-gray-500'>{product.location.city}</p>
										<p className='text-sm text-gray-500'>{product.location.country}</p>
